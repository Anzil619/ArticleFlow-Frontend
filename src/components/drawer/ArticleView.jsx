...
export function ArticleView({article_name , author,description , image, category, tags}) {
  ...
  return (
    <>
      <Button onClick={handleOpen} variant="text" className="flex items-center gap-2 mr-28">
              Read More
              <svg
  ...
  <h1 className="w-full overflow-x-auto whitespace-nowrap text-blue-900">{tags} </h1>
</div>
